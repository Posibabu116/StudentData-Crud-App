                ...
                <div className="table-wrapper">
                    <div className="table-title">
                        <div className="row">
                            ...
                            <div className="col-sm-6">
                                <a href="#" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#addStudentModal">
                            ...
                            {data.users?.map((elem, index) => {
                                return (
                                    <tr>
                                        ...
                                        <td>{elem.phone}</td>
                                        <td>
                                            <a href="#" className="edit cursor-pointer" data-bs-toggle="modal" data-bs-target="#editStudentModal" onClick={() => UpdatedUser(elem._id)}>
                                                <i className="material-icons" data-bs-toggle="tooltip" title="Edit">&#xE254;</i>
                                            </a>
                                            <a href="#" className="delete cursor-pointer" data-bs-toggle="modal" data-bs-target="#deleteStudentModal" onClick={() => Deletuser(elem._id)}>
